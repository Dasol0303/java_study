...
public class StudentDAO {
	...
	public StudentMypageDTO findStudentMypageInfoByStudno(int studno) {
		...
		try {
			...
			if (rs.next()) {
				...
				stud.setDeptno(rs.getInt("deptno"));
				stud.setDname(rs.getString("dname"));
				stud.setPart(rs.getInt("part"));
				stud.setBuild(rs.getString("build"));
	...
	public StudentDTO findStudentByStudno(int studno) {
		...
		String query = "select studno, name, id, grade, jumin,"
				+ " TO_CHAR(birthday, 'YYYY-MM-DD') birthday, tel,"
